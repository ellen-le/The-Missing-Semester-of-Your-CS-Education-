...
在 Shell 脚本中，通过 `date +[格式代码]` 可以自定义输出的时间格式。

| 代码 | 功能描述 | 示例输出 (2024-04-21 14:30:05) |
| :--- | :--- | :--- |
| **`%s`** | **Unix 时间戳** (从1970年至今的总秒数) | `1713681005` |
| `%Y` | 四位数的年份 | `2024` |
| `%m` | 两位数的月份 (01-12) | `04` |
| `%d` | 两位数的一月中的哪一天 | `21` |
...
| `%M` | 分钟 (00-59) | `30` |
| `%S` | 秒 (00-59) | `05` |
| **`%F`** | **全日期** (`%Y-%m-%d` 的缩写) | `2024-04-21` |
| **`%T`** | **全时间** (`%H:%M:%S` 的缩写) | `14:30:05` |
| `%w` | 星期几 (0-6，0 代表周日) | `0` |
